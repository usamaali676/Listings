                                            ...
                                            <div class="col-sm-6">
                                                <div class="vrt-list-thumb">
                                                    <div class="vrt-list-thumb-figure" style="height: 220px; width: 600px;">
                                                        <img src="{{asset('business/feature')}}/{{$item->featureImage}}" class="img-fluid" alt="" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                        ...
                        html += '<div class="grouping-listings-single">\
                                <div class="vrt-list-wrap">\
                                        <div class="row">\
                                            ...
                                            <div class="col-sm-6">\
                                                <div class="vrt-list-content">\
                                                    <h4 class="mb-0 ft-medium"><a href="{{route('business.single')}}/'+business[i]['slug']+'" class="text-dark fs-md">'+business[i]['name']+'<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a></h4>\
                                                    <div class="vrt-list-desc">\
