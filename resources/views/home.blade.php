		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6">
				<div class="dashboard-stat color-1">
					<div class="dashboard-stat-content"><h4>{{$bus}}</h4> <span>Active Listings</span></div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="dashboard-stat color-2">
					<div class="dashboard-stat-content"><h4>{{$statecount}}</h4> <span>States</span></div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="dashboard-stat color-3">
					<div class="dashboard-stat-content"><h4>{{$citycount}}</h4> <span>Cities</span></div>
